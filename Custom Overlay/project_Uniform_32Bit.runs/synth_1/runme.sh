...
HD_PWD='C:/Users/lpb16134/Xilinx/project_Uniform_32Bit/project_Uniform_32Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Uniform_32Bit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_Uniform_32Bit_wrapper.tcl
