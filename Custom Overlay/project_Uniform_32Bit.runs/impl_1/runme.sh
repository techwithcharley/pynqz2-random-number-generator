...
HD_PWD='C:/Users/lpb16134/Xilinx/project_Uniform_32Bit/project_Uniform_32Bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Uniform_32Bit_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_Uniform_32Bit_wrapper.tcl -notrace
