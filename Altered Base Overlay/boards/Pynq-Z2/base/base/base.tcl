...
User_Company:SysGen:uniform:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: uniform_0, and set properties
  set uniform_0 [ create_bd_cell -type ip -vlnv User_Company:SysGen:uniform:1.0 uniform_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets iop_pmodb_pmodb_gpio] [get_bd_intf_ports pmodb_gpio] [get_bd_intf_pins slice_pmodb_gpio/gpio]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins ps7_0_axi_periph/M08_AXI] [get_bd_intf_pins uniform_0/uniform_s_axi]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs uniform_0/uniform_s_axi/reg0] SEG_uniform_0_reg0
