...
HD_PWD='C:/Users/lpb16134/PYNQ-2.3/boards/Pynq-Z2/base/base/base.runs/base_s00_regslice_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_s00_regslice_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_s00_regslice_5.tcl
