...
HD_PWD='C:/Users/lpb16134/PYNQ-2.3/boards/Pynq-Z2/base/base/base.runs/base_intr_concat_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_intr_concat_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_intr_concat_1.tcl
